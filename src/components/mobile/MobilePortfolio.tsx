      ...
      <div className="max-w-md mx-auto px-5 pt-8 relative z-10 flex flex-col space-y-12">
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight text-white">Alex Carter</h1>
            <p className="text-lg text-gray-400 font-medium max-w-[280px] mx-auto leading-relaxed">
              Senior Frontend Architect & UX Engineer
            </p>
          </div>
          ...
          >
            <a href="https://github.com/alexcarterdev" target="_blank" rel="noreferrer" className="p-3 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-colors">
            ...
            <a href="https://linkedin.com/in/alexcarterdev" target="_blank" rel="noreferrer" className="p-3 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-colors">
            ...
            <a href="mailto:alex.carter.dev@gmail.com" className="p-3 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-colors">
