      ...
      <div className="max-w-md mx-auto px-5 pt-8 relative z-10 flex flex-col space-y-12">
        ...
        >
          ...
          >
            ...
            <a href="https://linkedin.com/in/farhancc" target="_blank" rel="noreferrer" className="p-3 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-colors">
